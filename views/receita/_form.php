...
<div class="receita-form">
    ...
    <div class="form-group">
        ...
        <?php echo Html::a(Icon::show('times') . ' Cancelar', ['index', 'id_consulta' => $model->id_consulta, 'id_fila' => Yii::$app->request->get('id_fila'), 'id_paciente' => Yii::$app->request->get('id_paciente')], ['class'=> 'btn btn-danger']) ?>
    </div>
